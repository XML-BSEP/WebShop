...
func (c2 campaignHandler) GenerateStatisticsReport(c echo.Context) error {
	...
	if os.Getenv("DOCKER_ENV") == "" {
		...
		resp, _ := client.R().
			SetHeader("Authorization", token).
			EnableTrace().
			Get("http://" + domain + ":8080/generateStatisticReport")
...
func (c2 campaignHandler) GetAllAdsPerAgent(c echo.Context) error {
	...
	if os.Getenv("DOCKER_ENV") == "" {
		...
		resp, _ := client.R().
			SetHeader("Authorization", token).
			EnableTrace().
			Get("http://" + domain + ":8080/getAdsByAgent")
...
func (c2 campaignHandler) DeleteDisposableCampaign(c echo.Context) error {
	...
	if os.Getenv("DOCKER_ENV") == "" {
		...
		resp, _ := client.R().
			...
			SetHeader("Authorization", token).
			EnableTrace().
			Post("http://" + domain + ":8080/deleteDisposableCampaign")
...
func (c2 campaignHandler) GetAllDisposableCampaigns(c echo.Context) error {
	...
	if os.Getenv("DOCKER_ENV") == "" {
		...
		resp, _ := client.R().
			SetHeader("Authorization", token).
			EnableTrace().
			Get("http://" + domain + ":8080/getAllDisposableCampaigns")
...
func (c2 campaignHandler) GetAllMultipleCampaigns(c echo.Context) error {
	...
	if os.Getenv("DOCKER_ENV") == "" {
		...
		resp, _ := client.R().
			SetHeader("Authorization", token).
			EnableTrace().
			Get("http://" + domain + ":8080/getAllMultipleCampaigns")
...
func (c2 campaignHandler) UpdateMultipleCampaign(c echo.Context) error {
	...
	if os.Getenv("DOCKER_ENV") == "" {
		...
		resp, _ := client.R().
			...
			SetHeader("Authorization", token).
			EnableTrace().
			Post("http://" + domain + ":8080/updateMultipleCampaign")
...
func (c2 campaignHandler) DeleteMultipleCampaign(c echo.Context) error {
	...
	if os.Getenv("DOCKER_ENV") == "" {
		...
		resp, _ := client.R().
			...
			SetHeader("Authorization", token).
			EnableTrace().
			Post("http://" + domain + ":8080/deleteMultipleCampaign")
...
func (c2 campaignHandler) CreateAd(c echo.Context) error {
	...
	if os.Getenv("DOCKER_ENV") == "" {
		...
		resp, _ := client.R().
			...
			SetHeader("Authorization", token).
			EnableTrace().
			Post("http://" + domain + ":8080/createAd")
...
func (c2 campaignHandler) CreateDisposableCampaign(c echo.Context) error {
	...
	if os.Getenv("DOCKER_ENV") == "" {
		...
		resp, _ := client.R().
			...
			SetHeader("Authorization", token).
			EnableTrace().
			Post("http://" + domain + ":8080/createDisposableCampaign")
...
func (c2 campaignHandler) CreateMultipleCampaign(c echo.Context) error {
	...
	if os.Getenv("DOCKER_ENV") == "" {
		...
		resp, _ := client.R().
			...
			SetHeader("Authorization", token).
			EnableTrace().
			Post("http://" + domain + ":8080/createMultipleCampaign")
